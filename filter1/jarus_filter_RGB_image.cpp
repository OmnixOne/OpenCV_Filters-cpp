...
jarus_RGB_filter_on_image='g++ jarus_RGB_filter_on_image.cpp -o jarus_RGB_filter_on_image -lueye_api -I/usr/local/include/opencv -I/usr/local/include -lserial -lpthread -lopencv_stitching -lopencv_superres -lopencv_videostab -lopencv_aruco -lopencv_bgsegm -lopencv_bioinspired -lopencv_ccalib -lopencv_dnn_objdetect -lopencv_dpm -lopencv_face -lopencv_freetype -lopencv_fuzzy -lopencv_hfs -lopencv_img_hash -lopencv_line_descriptor -lopencv_optflow -lopencv_reg -lopencv_rgbd -lopencv_saliency -lopencv_stereo -lopencv_structured_light -lopencv_phase_unwrapping -lopencv_surface_matching -lopencv_tracking -lopencv_datasets -lopencv_text -lopencv_highgui -lopencv_videoio -lopencv_dnn -lopencv_plot -lopencv_xfeatures2d -lopencv_shape -lopencv_video -lopencv_ml -lopencv_ximgproc -lopencv_xobjdetect -lopencv_objdetect -lopencv_calib3d -lopencv_imgcodecs -lopencv_features2d -lopencv_flann -lopencv_xphoto -lopencv_photo -lopencv_imgproc -lopencv_core'

$jarus_RGB_filter_on_image
...
static void refrashImage()
{
  ...
  cvtColor(matDilate, cgray, cv::COLOR_GRAY2RGB);
...
static void on_HueTrackbar1( int, void* ){refrashImage();}
static void on_HueTrackbar2( int, void* ){refrashImage();}

static void on_SatTrackbar1( int, void* ){refrashImage();}
static void on_SatTrackbar2( int, void* ){refrashImage();}
...
static void on_blur( int, void* ){refrashImage();}
...
int main(int argc, char** argv)
{
  ...
  src_img = imread(filename, cv::IMREAD_COLOR);
  if( src_img.empty() ) { cout << "Error loading src1 \n"; return -1; }
  ...
  createTrackbar( "blur", "jarus_window", &blur_size, 50, on_blur);   
  on_blur( blur_size, 0);
